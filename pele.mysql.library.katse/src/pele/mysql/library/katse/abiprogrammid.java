...
try{
	...
	String sql = "SELECT J‰rjekorranumber, Mast, Nimi, V‰‰rtus, Trump, Erinumber, PildiUrl, PildiUrlx FROM kaardipakk_in_game";
	...
	//	  System.out.println("sisestus real "+MastUrl[i]+" : "+MastUrl[(i+1)]+" : "+MastUrl[(i+2)]+" : "+MastUrl[(i+3)]+" : "+MastUrl[(i+4)]+" : "+MastUrl[(i+5)]+" : "+MastUrl[(i+6)]+" : "+MastUrl[(i+7)]);
		  ...
		  sql2="delete from kaardipakk_in_game where J‰rjekorranumber= "+MastUrl[i]+" ;";
